(function() {
  ...
  Menu.prototype = {
    ...
    create: function () {
      ...
      this.titleTxt = this.game.add.sprite(this.game.world.centerX - 100.5, 100, 'periaptDerecho');
      this.textReflect = this.game.add.sprite(this.game.world.centerX -300.5, 800, 'periaptReves');
      ...
      this.startTxt = this.game.add.text(this.game.world.centerX - 250, 650, "Press Enter to start!");
